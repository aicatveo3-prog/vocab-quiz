...
var DATA = ['js/data/words.js', 'js/data/words-b.js', 'js/data/words-c.js',
  'js/data/words-d.js', 'js/data/words-e.js', 'js/data/words-f.js', 'js/data/words-g.js', 'js/data/words-h.js', 'js/data/words-i.js', 'js/data/words-j.js', 'js/data/words-k.js', 'js/data/words-l.js', 'js/data/words-m.js', 'js/data/words-n.js', 'js/data/words-o.js', 'js/data/gloss.js', 'js/data/pron.js'];
...
var WORDS = (global.VOCAB || []).concat(global.VOCAB_B || [])
  ...
  .concat(global.VOCAB_J || [])
  .concat(global.VOCAB_K || [])
  .concat(global.VOCAB_L || [])
