/**
 * words-u.js 검사 — 매 차수마다 돌린다.
 *
 *   node tools/words-u-audit.js           전체 검사
 *   node tools/words-u-audit.js --rules   규칙별 검사 건수 (죽은 검사 탐지)
 *
 * 검사 6종
...
SET.forEach(function (x) {
  ...
  if (seen[l]) errors.push(at + ' U 세트 안에서 표제어 중복');
  seen[l] = 1;
