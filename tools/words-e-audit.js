...
['js/data/words.js', 'js/data/words-b.js', 'js/data/words-c.js', 'js/data/words-d.js',
 'js/data/words-e.js', 'js/data/gloss.js', 'js/data/pron.js', 'js/quizgen.js'].forEach(load);
...
console.log('  연어       ' + sim.colloc + ' / ' + E.filter(function (x) { return x.col && x.col.length; }).length);
