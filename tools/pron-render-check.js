...
['js/data/words.js', 'js/data/words-b.js', 'js/data/words-c.js', 'js/data/words-d.js', 'js/data/words-e.js', 'js/data/words-f.js', 'js/data/words-g.js', 'js/data/words-h.js', 'js/data/words-i.js', 'js/data/words-j.js', 'js/data/words-k.js', 'js/data/words-l.js',
 'js/data/gloss.js', 'js/data/pron.js'].forEach(load);

var ALL = (window.VOCAB || []).concat(window.VOCAB_B || [])
  .concat(window.VOCAB_C || []).concat(window.VOCAB_D || []).concat(window.VOCAB_E || [])
