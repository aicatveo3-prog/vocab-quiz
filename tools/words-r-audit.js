/**
 * words-r.js 검사 — 매 차수마다 돌린다.
 *
 *   node tools/words-r-audit.js           전체 검사
 *   node tools/words-r-audit.js --rules   규칙별 검사 건수 (죽은 검사 탐지)
 *
 * 검사 6종
