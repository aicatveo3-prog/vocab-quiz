...
const W3 = [
  ...
  {w:"be likely to",m:"~할 가능성이 있다",s:["be prone to ~하는 경향이 있다","be apt to ~하기 쉽다"],a:["be unlikely to ~할 가능성이 없다"],h:"likely → 가능성 있는",ex:"It is _____ rain tomorrow.",ek:"내일 비가 [올 가능성이 있다]"},
  ...
  {w:"blunt",m:"무딘, 뭉툭한",s:["dull 무딘","direct 직설적인","straightforward 솔직한"],a:["sharp 날카로운","subtle 미묘한"],h:"blunt→뭉툭한",ex:"He gave a _____ answer.",ek:"그는 [직설적인] 대답을 했다"},
...
const W5 = [
  ...
  {w:"be accompanied by",m:"~을 수반하다, 동반하다",s:["come with ~와 함께 오다","be attended by ~를 동반하다"],a:["be alone 혼자이다"],h:"accompany → 동반",ex:"The illness is often _____ fever.",ek:"그 병은 종종 열을 [수반한다]"},
