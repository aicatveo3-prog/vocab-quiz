 ...
 */
window.VOCAB_S = [
  { word:"secondary", exams:["공무원"], pron:"세컨더리", pos:"adj", level:"B2", meanings:["2차적인","부차적인"], syn:["subordinate","lesser","subsidiary"], ant:["primary"], ex:[{ s:"A library contains {{}} sources.", f:"secondary", ko:"도서관에는 2차 자료가 있다." }] },
  { word:"self-esteem", exams:["공무원"], pron:"셀프이스팀", pos:"n", level:"C1", meanings:["자존감","자부심"], syn:["self-worth","self-regard","pride"], ex:[{ s:"They believe praise builds a child's {{}}.", f:"self-esteem", ko:"그들은 칭찬이 아이의 자존감을 키운다고 믿는다." }] },
  { word:"self-reliance", exams:["공무원"], pron:"셀프릴라이언스", pos:"n", level:"C1", meanings:["자립","자기 의존"], syn:["independence","autonomy","self-sufficiency"], ant:["dependence"], ex:[{ s:"Urban agriculture is about food {{}}.", f:"self-reliance", ko:"도시 농업은 식량 자립에 관한 것이다." }] },
  { word:"semiotics", exams:["공무원"], pron:"세미아틱스", pos:"n", level:"C2", meanings:["기호학"], ex:[{ s:"The novel combines {{}} with biblical analysis.", f:"semiotics", ko:"그 소설은 기호학과 성경 분석을 결합한다." }] },
