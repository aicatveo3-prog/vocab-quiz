 ...
 */
window.VOCAB_F = [
  { word:"faction", exams:["공무원"], pron:"팩션", pos:"n", level:"C1", meanings:["파벌","분파"], syn:["clique","bloc","camp"], ex:[{ s:"The theory integrates all the major {{}} in the field.", f:"factions", ko:"그 이론은 그 분야의 모든 주요 분파를 통합한다." }] },
  { word:"fancy", exams:["공무원"], pron:"팬시", pos:"adj", level:"B2", meanings:["화려한","고급의"], syn:["elaborate","lavish","ornate"], ant:["plain"], ex:[{ s:"She wanted a small wedding rather than a {{}} one.", f:"fancy", ko:"그녀는 화려한 결혼식보다 작은 결혼식을 원했다." }] },
  { word:"fatigued", exams:["공무원"], pron:"퍼티그드", pos:"adj", level:"C1", meanings:["지친","피로한"], syn:["exhausted","weary","worn out"], ant:["refreshed"], ex:[{ s:"Workers feel {{}} and used up.", f:"fatigued", ko:"근로자들은 지치고 소진된 기분을 느낀다." }] },
  { word:"ferry", exams:["공무원"], pron:"페리", pos:"n", level:"B2", meanings:["여객선","페리"], syn:["boat","ferryboat","vessel"], ex:[{ s:"Provided the {{}} leaves on time, we will arrive by morning.", f:"ferry", ko:"여객선이 제때 떠난다면 우리는 아침까지 도착할 것이다." }] },
  { word:"firearm", exams:["공무원"], pron:"파이어암", pos:"n", level:"C1", meanings:["총기"], syn:["gun","weapon","pistol"], ex:[{ s:"The court upheld the right of states to regulate {{}}.", f:"firearms", ko:"법원은 주가 총기를 규제할 권리를 인정했다." }] },
  { word:"flask", exams:["공무원"], pron:"플라스크", pos:"n", level:"B2", meanings:["플라스크","병"], syn:["bottle","container","vial"], ex:[{ s:"The chemist dropped a glass {{}} on the floor.", f:"flask", ko:"그 화학자는 유리 플라스크를 바닥에 떨어뜨렸다." }] },
  { word:"focal", exams:["공무원"], pron:"포컬", pos:"adj", level:"C1", meanings:["중심의","초점의"], syn:["central","pivotal","key"], ex:[{ s:"Americans made more references to the {{}} fish.", f:"focal", ko:"미국인들은 중심이 되는 물고기를 더 많이 언급했다." }] },
  { word:"foreigner", exams:["공무원"], pron:"포리너", pos:"n", level:"B2", meanings:["외국인"], syn:["alien","outsider","newcomer"], ant:["native"], ex:[{ s:"The adult {{}} has little chance to practice the language.", f:"foreigner", ko:"성인 외국인은 그 언어를 연습할 기회가 거의 없다." }] },
