 ...
 */
window.VOCAB_D = [
  { word:"debasement", exams:["공무원"], pron:"디베이스먼트", pos:"n", level:"C2", meanings:["가치 저하","질 저하"], syn:["degradation","devaluation","adulteration"], ex:[{ s:"Currency {{}} occurred via diluted coins.", f:"debasement", ko:"주화를 희석하면서 화폐 가치 저하가 일어났다." }] },
  { word:"deceased", exams:["공무원"], pron:"디시스트", pos:"adj", level:"C1", meanings:["사망한","고인이 된"], syn:["dead","departed","late"], ant:["living"], ex:[{ s:"Ties with the {{}} are maintained in some cultures.", f:"deceased", ko:"일부 문화에서는 고인과의 유대가 유지된다." }] },
  { word:"demonstration", exams:["공무원"], pron:"데먼스트레이션", pos:"n", level:"B2", meanings:["시연","시위"], syn:["display","exhibition","protest"], ex:[{ s:"He conducted a {{}} before the emperor.", f:"demonstration", ko:"그는 황제 앞에서 시연을 했다." }] },
  ...
  { word:"discontinue", exams:["공무원"], pron:"디스컨티뉴", pos:"v", level:"B2", meanings:["중단하다"], syn:["stop","cease","suspend"], ant:["continue"], ex:[{ s:"Organizers may {{}} in-person ticket sales.", f:"discontinue", ko:"주최 측은 현장 판매를 중단할 수 있다." }] },
  { word:"discriminating", exams:["공무원"], pron:"디스크리미네이팅", pos:"adj", level:"C1", meanings:["안목 있는","식별력 있는"], syn:["discerning","selective","refined"], ant:["undiscriminating"], ex:[{ s:"As prices rise, consumers become more {{}}.", f:"discriminating", ko:"가격이 오르면 소비자는 더 까다로워진다." }] },
  { word:"disparate", exams:["공무원"], pron:"디스퍼릿", pos:"adj", level:"C2", meanings:["이질적인","서로 다른"], syn:["different","distinct","dissimilar"], ant:["similar"], ex:[{ s:"Its {{}} parts must become integrated again.", f:"disparate", ko:"그 이질적인 부분들이 다시 통합되어야 한다." }] },
  { word:"dissatisfy", exams:["공무원"], pron:"디스새티스파이", pos:"v", level:"C1", meanings:["불만족시키다"], syn:["displease","disappoint","frustrate"], ant:["satisfy"], ex:[{ s:"Poor service can {{}} loyal customers.", f:"dissatisfy", ko:"형편없는 서비스는 단골 고객을 불만족시킬 수 있다." }] },
  { word:"dissolute", exams:["공무원"], pron:"디설루트", pos:"adj", level:"C2", meanings:["방탕한"], syn:["debauched","licentious","decadent"], ant:["virtuous"], ex:[{ s:"The king lost his treasure on {{}} living.", f:"dissolute", ko:"그 왕은 방탕한 생활로 재물을 잃었다." }] },
